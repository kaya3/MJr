...
namespace ASG {
    ...
    export interface ConvChainStmt extends _StmtNode<'convchain', {inGrid: number, weights: readonly WeightedPattern[], output: readonly number[], temperature: Prop<'float?'>, epsilon: number, on: Pattern}> {}
