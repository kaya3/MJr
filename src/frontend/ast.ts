...
namespace AST {
    ...
    export interface ConvChainStmt extends _StmtNode<'convchain', {sample: Expression, n: Expression, temperature?: Expression, anneal?: Expression, on?: Expression, epsilon?: Expression, periodic?: Expression}> {}
